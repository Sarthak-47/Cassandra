...
class ProxyLaunchConfig(BaseModel):
    """How arms.py launches and probes the Cassandra proxy. No command is hardcoded in logic."""

    cassandra_cmd: list[str] = Field(default_factory=lambda: ["cassandra", "proxy"])

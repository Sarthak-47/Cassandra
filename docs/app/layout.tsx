...
// custom domain).
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://cassandra-docs.vercel.app';

export const metadata: Metadata = {
  title: {
    default: 'Cassandra — Context Optimization Layer for AI Agents',
  ...
  openGraph: {
    type: 'website',
    siteName: 'Cassandra',
    title: 'Cassandra — Context Optimization Layer for AI Agents',
    description:

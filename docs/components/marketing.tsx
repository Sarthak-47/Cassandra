...
const integrations: {
...
}[] = [
  {
    ...
    code: 'from cassandra.integrations.langchain import CassandraChatModel\nllm = CassandraChatModel(ChatOpenAI())',
    lang: 'python',
    href: '/docs/langchain',
  },
  {
    ...
    code: 'from cassandra.integrations.agno import CassandraAgnoModel\nmodel = CassandraAgnoModel(Claude())\nagent = Agent(model=model)',
    lang: 'python',
    href: '/docs/agno',
  },
  {
    ...
    code: 'from cassandra.integrations.strands import CassandraStrandsModel\nmodel = CassandraStrandsModel(...)\nagent = Agent(model=model)',
    lang: 'python',
    href: '/docs/strands',
  },
  {
    ...
    code: 'cassandra mcp install && claude',
    lang: 'bash',
    href: '/docs/mcp',
  },
  {
  ...
  },
  {
    title: 'Vercel AI SDK',
    description:
      'One-liner withCassandra() or cassandraMiddleware() for any Vercel AI SDK model.',
    code: "import { withCassandra } from 'cassandra-ai/vercel-ai'\nconst model = withCassandra(openai('gpt-4o'))",
    lang: 'typescript',
    href: '/docs/vercel-ai-sdk',
  },
];

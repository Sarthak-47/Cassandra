"""Relevance scorer benchmarks for Cassandra SDK.
...
class TestBM25Benchmarks:
    ...
    def scorer(self):
        ...
        from cassandra.relevance.bm25 import BM25Scorer
...
class TestHybridBenchmarks:
    ...
    def scorer_fallback(self):
        ...
        from cassandra.relevance.bm25 import BM25Scorer
        from cassandra.relevance.hybrid import HybridScorer
...
class TestScorerFactoryBenchmarks:
    ...
    def test_create_bm25_scorer(self, benchmark):
        ...
        """
        from cassandra.relevance import create_scorer
...
class TestRelevanceInSmartCrusher:
    ...
    def crusher_with_bm25(self, smart_crusher_config):
        ...
        from cassandra.config import RelevanceScorerConfig
...
def _check_embedding_available() -> bool:
    ...
    try:
        from cassandra.relevance.embedding import EmbeddingScorer

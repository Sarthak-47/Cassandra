#!/usr/bin/env python3
"""CLI runner for Cassandra benchmark suite.

This script provides a convenient interface for running benchmarks and
generating reports. It wraps pytest-benchmark with Cassandra-specific
...
def generate_markdown_report(
    ...
    # Header
    lines.append("# Cassandra SDK Benchmark Report")
    lines.append("")
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Run Cassandra SDK benchmarks",

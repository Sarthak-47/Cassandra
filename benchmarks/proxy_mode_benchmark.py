...
def _print_real_harness() -> None:
    ...
    print("  1) Start proxy in cache mode:  CASSANDRA_MODE=cache cassandra proxy --port 8787")
    print("  2) Start proxy in token mode:  CASSANDRA_MODE=token cassandra proxy --port 8787")

//! Token counting for Cassandra transforms.
//!
//! Mirrors the public surface of the Python `cassandra.tokenizers` package:
...
//!
//! # What this is NOT
//! - Not used by `cassandra-proxy` yet (Stage 2 is library-only; no production
//!   wiring).

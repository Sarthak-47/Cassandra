...
//!
//! Mirrors `MODEL_PATTERNS` in `cassandra/tokenizers/registry.py`. Three
...
///
/// Patterns and ordering match `cassandra.tokenizers.registry.MODEL_PATTERNS`
...
///
/// ```no_run
/// use cassandra_core::tokenizer::try_register_hf;

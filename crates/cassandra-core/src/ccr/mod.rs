...
//! end-to-end.
//!
//! Mirrors the semantics of Python's [`CompressionStore`] (`cassandra/
...
//!
//! [`CompressionStore`]: https://github.com/Sarthak-47/cassandra/blob/main/cassandra/cache/compression_store.py
...
pub fn compute_key(payload: &[u8]) -> String {
    ...
    // (`[a-f0-9]{24}`) — see `cassandra/ccr/tool_injection.py:211`.
...
/// calls `cassandra_retrieve`. Format is intentionally fixed across

//! Unified-diff compressor — Rust port of `cassandra.transforms.diff_compressor`.
//!
...
/// Priority patterns matching `cassandra.transforms.error_detection.PRIORITY_PATTERNS_DIFF`:
...
/// `cassandra.cache.compression_store.CompressionStore.store`.

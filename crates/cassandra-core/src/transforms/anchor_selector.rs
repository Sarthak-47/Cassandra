...
//!
//! Direct port of `cassandra/transforms/anchor_selector.py`. Used by
...
// ============================================================================
// Configuration (Python `cassandra/config.py:294` AnchorConfig)
// ============================================================================

/// Configuration for dynamic anchor allocation.
///
/// Direct port of Python `AnchorConfig` (`cassandra/config.py:294-348`).

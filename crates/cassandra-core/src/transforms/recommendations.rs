...
//!
//! 1. The Python `cassandra.cli.toin_publish` CLI walks the on-disk TOIN
...
/// not propagate.
pub const RECOMMENDATIONS_PATH_ENV_VAR: &str = "CASSANDRA_RECOMMENDATIONS_PATH";
...
///
/// Honors `CASSANDRA_RECOMMENDATIONS_PATH` for prod overrides; falls

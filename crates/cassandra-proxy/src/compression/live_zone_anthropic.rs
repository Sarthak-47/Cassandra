...
//! [`cassandra_core::transforms::LiveZoneOutcome`] and the
...
//!    [`cassandra_core::transforms::compress_anthropic_live_zone`].
...
//! `crates/cassandra-core/tests/live_zone_dispatch.rs` pins the
//! SHA-256 prefix-and-suffix invariant in CI.

use bytes::Bytes;
use cassandra_core::auth_mode::AuthMode as RequestAuthMode;
use cassandra_core::transforms::live_zone::DEFAULT_MODEL;

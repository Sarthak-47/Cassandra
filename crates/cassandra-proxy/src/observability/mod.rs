...
//! `cassandra_core::auth_mode::AuthMode` enum (3 variants total).
...
pub use proxy_metrics::{
    extract_rate_limit_snapshot, record_conversations_api_request,
    record_passthrough_bytes_modified, record_prefix_drift_detected, record_rate_limit_snapshot,

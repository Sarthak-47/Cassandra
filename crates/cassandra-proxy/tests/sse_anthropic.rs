...
//! the Anthropic Messages spec (and the Cassandra realignment guide
//! §5.1) requires.
//!
...
use bytes::Bytes;
use cassandra_proxy::sse::anthropic::{AnthropicStreamState, StreamStatus};
...
#[allow(dead_code)]
fn _ref_event() -> cassandra_proxy::sse::SseEvent {
    cassandra_proxy::sse::SseEvent {
        event_name: None,

"""Shared utilities for Cassandra SDK."""
...
# Marker format for Cassandra modifications
MARKER_PREFIX = "<cassandra:"
MARKER_SUFFIX = ">"
...
def create_marker(marker_type: str, **kwargs: Any) -> str:
    """
    Create a Cassandra marker string.
...
def extract_markers(text: str) -> list[dict[str, Any]]:
    """
    Extract Cassandra markers from text.

    Returns:
        List of dicts with marker_type and attributes.
    """
    pattern = re.compile(r"<cassandra:(\w+)([^>]*)>")
    markers = []

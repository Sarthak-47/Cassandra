...
Four key components:
1. Tool Injection: Proxy injects cassandra_retrieve tool into requests
...
try:
    from .mcp_server import CassandraMCPServer, create_ccr_mcp_server

    MCP_SERVER_AVAILABLE = True
except ImportError:
    CassandraMCPServer = None  # type: ignore

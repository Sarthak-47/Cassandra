...
When the LLM calls cassandra_retrieve, this handler:
...
class CCRResponseHandler:
    ...
    Example flow:
    1. LLM response contains: tool_use(cassandra_retrieve, hash=abc123)
    ...
    def has_ccr_tool_calls(
        ...
        Returns:
            True if response contains cassandra_retrieve tool calls.
        """
        ...
        while rounds < self.config.max_retrieval_rounds:
            ...
            if other_calls:
                logger.warning(
                    ...
                    "alongside cassandra_retrieve. Cannot create a valid continuation "

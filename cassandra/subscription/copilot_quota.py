...
come from the environment at cassandra start-up.
...
class _CopilotQuotaTracker(QuotaTracker):
    ...
    Implements :class:`~cassandra.subscription.base.QuotaTracker` so it can be
    registered with the :class:`~cassandra.subscription.base.QuotaTrackerRegistry`.
    ...
    async def _poll_loop(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                # note in cassandra/subscription/tracker.py:_poll_loop.

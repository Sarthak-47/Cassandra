...
Mirrors the Anthropic OAuth usage API response exactly, including:
  ...
  - Cassandra contribution: tokens conserved by compression, CLI filtering, cache
...
# ---------------------------------------------------------------------------
# Cassandra contribution estimate
# ---------------------------------------------------------------------------


@dataclass
class CassandraContribution:
    """Tokens conserved within the current 5h window by Cassandra's layers.
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "raw_without_cassandra": self.raw_without_cassandra(),
...
class SubscriptionState:
    ...
    contribution: CassandraContribution = field(default_factory=CassandraContribution)

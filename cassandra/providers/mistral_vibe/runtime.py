...
from cassandra.providers.codex import proxy_base_url as codex_proxy_base_url
from cassandra.proxy.project_context import with_project_prefix
...
def build_launch_env(
    ...
    as a JSON array. When routing through Cassandra, we set the mistral provider's
    ...
    # NOTE: With a persistent Cassandra deployment (`cassandra install`), the proxy
    ...
    # Build the providers JSON with mistral provider pointing to Cassandra proxy

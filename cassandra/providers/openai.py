"""OpenAI provider implementation for Cassandra SDK.
...
def _load_custom_model_config() -> dict[str, Any]:
    ...
    if env_config:
        try:
            ...
            logger.debug("Loaded custom OpenAI model config from CASSANDRA_MODEL_LIMITS")
...
class OpenAIProvider(Provider):
    ...
    Custom Model Configuration:
        ...
        1. Environment variable (JSON string):
           export CASSANDRA_MODEL_LIMITS='{"openai": {"context_limits": {"my-model": 128000}}}'
    ...
    def get_context_limit(self, model: str) -> int:
        ...
        4. ~/.cassandra/models.json config file

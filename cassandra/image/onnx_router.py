...
- Sarthak-47/technique-router-onnx (~32 MB)
- Sarthak-47/siglip-image-encoder-onnx (~95 MB)
"""
...
from cassandra.image.trained_router import ImageSignals, RouteDecision, Technique
from cassandra.onnx_runtime import create_cpu_session_options, hf_hub_download_local_first

logger = logging.getLogger(__name__)

_TECHNIQUE_ROUTER_REPO = "Sarthak-47/technique-router-onnx"
_SIGLIP_ENCODER_REPO = "Sarthak-47/siglip-image-encoder-onnx"

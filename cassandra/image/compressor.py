...
This is the main entry point for image compression in Cassandra.
It automatically:
...
class ImageCompressor:
    ...
    https://huggingface.co/Sarthak-47/technique-router

    Args:
        model_id: HuggingFace model ID (default: Sarthak-47/technique-router)

"""Local backend adapter for Cassandra's hierarchical memory system.
...
from cassandra.memory.adapters.graph_models import Entity, Relationship, Subgraph
...
class LocalBackend:
    ...
    async def _ensure_initialized(self) -> None:
        ...
        if not self._initialized:
            ...
            from cassandra.memory.config import EmbedderBackend
    ...
    async def text_search(
        ...
        from cassandra.memory.ports import TextFilter

"""Cassandra Memory - Simple, zero-config memory for AI applications.

Quick Start (No Docker Required):
    from cassandra.memory import Memory
...
Advanced Usage - LLM Wrapper:
    ...
    from cassandra.memory import with_memory
...
Advanced Usage - Tool-based:
    from openai import OpenAI
    from cassandra.memory import with_memory_tools, LocalBackend
...
# Graph adapters
# =============================================================================
from cassandra.memory.adapters.graph import InMemoryGraphStore
...
# =============================================================================
# Memory Bridge (markdown <-> Cassandra bidirectional sync)
# =============================================================================
from cassandra.memory.bridge import ImportStats, MemoryBridge, SyncStats
from cassandra.memory.bridge_config import BridgeConfig, MarkdownFormat
from cassandra.memory.config import (
    EmbedderBackend,
    MemoryConfig,
    StoreBackend,
    TextBackend,
...
# Core orchestrator
# =============================================================================
from cassandra.memory.core import HierarchicalMemory

# =============================================================================
# Simple API (recommended for most users)
# =============================================================================
from cassandra.memory.easy import Memory, MemoryResult

# =============================================================================
# Factory
# =============================================================================
from cassandra.memory.factory import create_memory_system

# =============================================================================
# Data models (internal)
# =============================================================================
from cassandra.memory.models import Memory as MemoryModel
from cassandra.memory.models import ScopeLevel

# =============================================================================
# Protocol interfaces (ports)
# =============================================================================
from cassandra.memory.ports import (
    # Core protocols
    Embedder,
    # Graph dataclasses
    Entity,
...
# =============================================================================
from cassandra.memory.system import MemoryBackend, MemorySystem

# =============================================================================
# Memory tools for LLM function calling
# =============================================================================
from cassandra.memory.tools import (
    MEMORY_TOOLS,
...
# =============================================================================
from cassandra.memory.wrapper import MemoryWrapper, with_memory

# =============================================================================
# Tool-based wrapper for LLM clients
# =============================================================================
from cassandra.memory.wrapper_tools import MemoryToolsWrapper, with_memory_tools
...
def __getattr__(name: str) -> type:
    ...
    if name == "Mem0Backend":
        if _Mem0Backend is None:
            from cassandra.memory.backends.mem0 import Mem0Backend
    ...
    if name == "DirectMem0Adapter":
        if _DirectMem0Adapter is None:
            from cassandra.memory.backends.direct_mem0 import DirectMem0Adapter
    ...
    if name == "DirectMem0Config":
        if _DirectMem0Config is None:
            from cassandra.memory.backends.direct_mem0 import Mem0Config as DirectMem0Config

...
Writers convert Cassandra memory entries into agent-specific file formats.
...
# Marker delimiters for Cassandra-managed sections (matches learn/writer.py)
MARKER_START = "<!-- cassandra:memory:start -->"
MARKER_END = "<!-- cassandra:memory:end -->"

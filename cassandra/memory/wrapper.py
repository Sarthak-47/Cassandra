"""Memory wrapper - the main API for Cassandra Memory.
...
from cassandra.memory.inline_extractor import (
...
class MemoryWrapper:
    ...
    def __init__(
        ...
        client: Any,
        user_id: str,
        db_path: str | Path = "cassandra_memory.db",
        top_k: int = 5,
...
class _MemoryAPI:
    ...
    def get_all(self) -> list[Memory]:
        ...
        from cassandra.memory.ports import MemoryFilter
...
def with_memory(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        user_id: User identifier for memory isolation
        db_path: Path to SQLite database (default: cassandra_memory.db)

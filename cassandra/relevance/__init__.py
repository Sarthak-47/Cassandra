"""Relevance scoring module for Cassandra SDK.
...
1. HybridScorer (DEFAULT - recommended)
   ...
   - Install for full support: pip install cassandra[relevance]
...
3. EmbeddingScorer (requires sentence-transformers)
   ...
   - Install: pip install cassandra[relevance]
...
Example usage:
    from cassandra.relevance import HybridScorer, create_scorer

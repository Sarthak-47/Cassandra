"""Base class for cassandra learn plugins.
...
class LearnPlugin(ABC):
    ...
    Plugins are discovered automatically from cassandra.learn.plugins.*
    or via ``cassandra.learn_plugin`` entry points for external packages.

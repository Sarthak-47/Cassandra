...
Automatically detects the correct Cassandra provider based on the Agno model type.
"""
...
from cassandra.providers import (
    AnthropicProvider,
    CohereProvider,
    GoogleProvider,
    OpenAIProvider,
...
# Mapping from Agno model class names to Cassandra providers
...
def get_cassandra_provider(agno_model: Any) -> Provider:
    """Get the appropriate Cassandra provider for an Agno model.
    ...
    Returns:
        Appropriate Cassandra Provider instance.
    ...
    Example:
        ...
        provider = get_cassandra_provider(model)  # Returns OpenAIProvider
    """

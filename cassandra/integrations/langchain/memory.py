...
This module provides CassandraChatMessageHistory, a wrapper for any LangChain
...
Example:
    ...
    compressed_history = CassandraChatMessageHistory(base_history)
...
if TYPE_CHECKING:
    from cassandra.providers.base import Provider
...
class CassandraChatMessageHistory(BaseChatMessageHistory):
    ...
    Example:
        ...
        compressed = CassandraChatMessageHistory(
            base,
    ...
    def __init__(
        ...
        """Initialize CassandraChatMessageHistory.
        ...
        Args:
            ...
            model: Model name for token counting. Default "gpt-4o".
            provider: Cassandra provider for token counting. Auto-uses
    ...
    def messages(self) -> list[BaseMessage]:  # type: ignore[override]
        ...
        logger.info(
            f"CassandraChatMessageHistory compressed: {token_count} -> {tokens_after} tokens "
    ...
    def _apply_compression(self, messages: list[BaseMessage]) -> list[BaseMessage]:
        ...
        Returns:
            ...
            applicable.
        """
        # Convert to OpenAI format for Cassandra transforms

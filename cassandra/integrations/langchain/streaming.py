...
Example:
    ...
    from cassandra.integrations import CassandraChatModel, StreamingMetricsTracker
...
class StreamingMetricsTracker:
    ...
    def __init__(
        ...
        Args:
            ...
            provider: Cassandra provider for token counting. Uses
...
class StreamingMetricsCallback:
    ...
    def __init__(self, model: str = "gpt-4o", provider: Any = None):
        ...
        Args:
            model: Model name for token counting.
            provider: Cassandra provider for token counting.
        """

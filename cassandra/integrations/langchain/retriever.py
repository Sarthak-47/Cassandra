...
This module provides CassandraDocumentCompressor, a LangChain BaseDocumentCompressor
...
class CassandraDocumentCompressor(BaseDocumentCompressor):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize CassandraDocumentCompressor.
    ...
    def compress_documents(
        ...
        logger.info(
            f"CassandraDocumentCompressor: {len(documents)} -> {len(final_docs)} documents "

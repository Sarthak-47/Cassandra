...
Automatically detects the correct Cassandra provider based on the Strands model type.
"""
...
# Mapping from Strands model class names to Cassandra providers
...
def get_cassandra_provider(model: Any) -> Provider:
    """Get the appropriate Cassandra provider for a Strands model.
    ...
    Example:
        ...
        from cassandra.integrations.strands.providers import get_cassandra_provider

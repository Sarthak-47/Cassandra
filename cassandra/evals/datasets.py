...
from cassandra.evals.core import EvalCase, EvalSuite
...
def load_tool_output_samples() -> EvalSuite:
    ...
    These are realistic tool outputs that cassandra is designed to compress:
    - API responses (JSON)
    - Log outputs
    - Code files

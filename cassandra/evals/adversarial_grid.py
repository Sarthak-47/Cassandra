"""Adversarial robustness grid for Cassandra compressors (offline, no LLM).
...
- abuse compressor control surfaces. Cassandra has a concrete instance:
...
# Cassandra-specific CCR marker spoof. benign_control anchors the baseline.

"""Memory evaluation framework for Cassandra.
...
Example:
    from cassandra.evals.memory import LoCoMoEvaluator, MemoryEvalConfig
...
from cassandra.evals.memory.judge import (
...
from cassandra.evals.memory.runner import (
    LoCoMoEvaluator,
    MemoryEvalConfig,
    MemoryEvalResult,
...
from cassandra.evals.memory.runner_v2 import (
    EvalMetrics,
    LoCoMoEvaluatorV2,
    MemoryEvalConfigV2,
    MemoryEvalResultV2,

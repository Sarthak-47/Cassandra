...
Install with: pip install cassandra-ai[evals]

Quick start:
    from cassandra.evals import run_quick_eval
    results = run_quick_eval(n_samples=5)
    print(results.summary())

Batch compression eval:
    from cassandra.evals import run_batch_compression_eval
...
from cassandra.evals.runners.before_after import (
    BeforeAfterRunner,
    LLMConfig,
    run_quick_eval,
)
from cassandra.transforms.content_router import ContentRouterConfig

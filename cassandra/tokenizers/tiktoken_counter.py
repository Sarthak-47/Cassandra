...
def _load_timeout_seconds() -> float:
    try:
        return float(os.environ.get("CASSANDRA_TIKTOKEN_LOAD_TIMEOUT_SECONDS", "10"))
...
def _get_encoding(encoding_name: str):
    ...
    Bounded by ``CASSANDRA_TIKTOKEN_LOAD_TIMEOUT_SECONDS`` (default 10s): tiktoken's
    ...
    if worker.is_alive():
        ...
        logger.warning(
            ...
            "or tune CASSANDRA_TIKTOKEN_LOAD_TIMEOUT_SECONDS.",
            encoding_name,

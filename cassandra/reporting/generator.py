"""HTML report generator for Cassandra SDK."""
...
def _get_jinja2_template(template_str: str):
    ...
    try:
        ...
        raise ImportError(
            "jinja2 is required for report generation. Install with: pip install cassandra[reports]"
        ) from e
...
<head>
    ...
    <title>Cassandra Report - {{ generated_at }}</title>
    <style>
        * {
...
<body>
    <div class="container">
        <header>
            <h1>Cassandra Context Analysis Report</h1>
        ...
        <footer>
            Generated by Cassandra SDK v0.1.0
        </footer>
    </div>
</body>
</html>
...
def _generate_recommendations(
    ...
    if stats["total_tokens_saved"] > 0:
        ...
        recommendations.append(
            {
                "title": "Get Started",
                "description": "No optimizations applied yet. Try setting cassandra_mode='optimize' "

...
changes, cache clears, stats resets) to the dedicated ``cassandra.audit``
...
``CASSANDRA_STATELESS`` (no filesystem writes) and respects whatever log sink

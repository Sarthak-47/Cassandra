"""AWS Bedrock ``InvokeModel`` passthrough handler for CassandraProxy.
...
through Cassandra's catch-all and were forwarded verbatim — no compression.
...
class BedrockHandlerMixin:
    ...
    async def handle_bedrock_invoke(
        ...
        *,
        ...
        bypass = (
            _cassandra_bypass_enabled(request.headers)

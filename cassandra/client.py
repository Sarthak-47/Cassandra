"""Main CassandraClient implementation for Cassandra SDK."""
...
class ChatCompletions:
    ...
    def create(
        ...
        *,
        ...
        cassandra_mode: str | None = None,
        cassandra_cache_prefix_tokens: int | None = None,
        cassandra_output_buffer_tokens: int | None = None,
        cassandra_keep_turns: int | None = None,
        cassandra_tool_profiles: dict[str, dict[str, Any]] | None = None,
        # Pass through all other kwargs
        **kwargs: Any,
    ) -> Any:
        """
        Create a chat completion with optional Cassandra optimization.

        Args:
            model: Model name.
            messages: List of messages.
            stream: Whether to stream the response.
            cassandra_mode: Override default mode ("audit" | "optimize").
            cassandra_cache_prefix_tokens: Target cache-aligned prefix size.
            cassandra_output_buffer_tokens: Reserve tokens for output.
            cassandra_keep_turns: Never drop last N turns.
            cassandra_tool_profiles: Per-tool compression config.
        ...
        return self._client._create(
            ...
            messages=messages,
            stream=stream,
            cassandra_mode=cassandra_mode,
            cassandra_cache_prefix_tokens=cassandra_cache_prefix_tokens,
            cassandra_output_buffer_tokens=cassandra_output_buffer_tokens,
            cassandra_keep_turns=cassandra_keep_turns,
            cassandra_tool_profiles=cassandra_tool_profiles,
            api_style="openai",
            **kwargs,
        )
    ...
    def simulate(
        ...
        **kwargs: Any,
        ...
        Args:
            model: Model name.
            messages: List of messages.
            cassandra_mode: Mode to simulate.
            cassandra_output_buffer_tokens: Output buffer to use.
            cassandra_tool_profiles: Tool profiles to use.
...
class Messages:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """
        Create a message with optional Cassandra optimization.
    ...
    def stream(
        ...
        **kwargs: Any,
        ...
        """
        Stream a message with optional Cassandra optimization.
...
class CassandraClient:
    ...
    def __init__(
        ...
        Args:
            ...
            config: Optional CassandraConfig for full control over all settings.
        ...
        if store_url is None:
            ...
            db_path = os.path.join(tempfile.gettempdir(), "cassandra.db")
            store_url = f"sqlite:///{db_path}"

        self._store_url = store_url
        self._default_mode = CassandraMode(default_mode)
    ...
    def _create(
        ...
        **kwargs: Any,
        ...
        mode = CassandraMode(cassandra_mode) if cassandra_mode else self._default_mode
        ...
        if mode == CassandraMode.OPTIMIZE:
            output_buffer = cassandra_output_buffer_tokens or self._config.output_buffer_tokens
            ...
            result = self._pipeline.apply(
                ...
                tool_profiles=cassandra_tool_profiles or {},
            )
    ...
    def validate_setup(self) -> dict[str, Any]:
        """Validate that Cassandra is properly configured.
        ...
        try:
            # Check mode is valid
            if self._default_mode in (CassandraMode.AUDIT, CassandraMode.OPTIMIZE):

"""Cassandra Backends - API translation layers for different LLM providers.
...
Usage:
    # LiteLLM backend
    cassandra proxy --backend litellm-bedrock --region us-west-2

    # any-llm backend
    cassandra proxy --backend anyllm --anyllm-provider openai
"""

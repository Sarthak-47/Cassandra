"""Canonical Cassandra pipeline lifecycle and extension contracts."""
...
ENTRY_POINT_GROUP = "cassandra.pipeline_extension"


class PipelineStage(str, Enum):
    """Stable lifecycle stages for the canonical Cassandra pipeline."""

"""rtk (Rust Token Killer) integration for Cassandra.

rtk compresses CLI output (test results, git diffs, log dumps) before it
enters the LLM context window. Cassandra downloads and manages the rtk binary.
"""
...
def _managed_rtk_candidates() -> list[Path]:
    """Return known Cassandra-managed rtk binary paths."""

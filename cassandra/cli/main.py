"""Main CLI entry point for Cassandra."""
...
@click.version_option(get_version(), "--version", "-v", prog_name="cassandra")
@click.pass_context
def main(ctx: click.Context) -> None:
    ...
    Examples:
        ...
        cassandra update             Update Cassandra to the latest release
    """
    ...
    if ctx.invoked_subcommand != "update":
        try:
            from cassandra.update_check import maybe_check_async

...
def audit_reads_cmd(
    ...
    \b
    Examples:
        cassandra audit-reads
        cassandra audit-reads --path /var/transcripts --format json
        cassandra audit-reads --codex
    """
    ...
    if codex_mode:
        ...
        from cassandra.audit.codex import audit_codex, render_codex_text
    ...
    if simulate_maturation:
        from cassandra.audit.maturation import render_sim_text
        from cassandra.audit.maturation import simulate_maturation as run_sim

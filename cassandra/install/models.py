...
class RuntimeKind(str, Enum):
    """Runtime used to execute Cassandra."""
...
class ManagedMutation:
    """A reversible change applied by `cassandra install`."""
...
class DeploymentManifest:
    ...
    image: str = "ghcr.io/Sarthak-47/cassandra:latest"
    service_name: str = "cassandra"
    container_name: str = "cassandra-persistent"

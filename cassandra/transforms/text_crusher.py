...
Thin Python wrapper over the native ``cassandra._core.TextCrusher``. The
algorithm (sentence scoring with the SHARED BM25 relevance scorer + global
word-shingle near-dup suppression) lives in Rust (``crates/cassandra-core``),
...
from cassandra._core import TextCrusher as _RustTextCrusher
from cassandra._core import TextCrusherConfig as _RustTextCrusherConfig

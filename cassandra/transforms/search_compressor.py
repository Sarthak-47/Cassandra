...
`crates/cassandra-core/src/transforms/search_compressor.rs`. This module
...
class SearchCompressor:
    ...
    def _parse_search_results(self, content: str) -> dict[str, FileMatches]:
        ...
        from cassandra._core import parse_search_lines
    ...
    def _score_matches(
        ...
        """
        from cassandra.transforms.error_detection import PRIORITY_PATTERNS_SEARCH
    ...
    def _select_matches(
        ...
        from cassandra.transforms.adaptive_sizer import compute_optimal_k

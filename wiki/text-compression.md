...
For coding tasks, Cassandra provides **standalone text compression utilities** that applications can use explicitly. These are **opt-in** — they're not applied automatically, giving you full control over when and how to compress text content.
...
```python
from cassandra.transforms import SearchCompressor
...
```python
from cassandra.transforms import LogCompressor
...
```python
from cassandra.transforms import TextCompressor
...
```python
from cassandra.transforms import detect_content_type, ContentType
...
```python
from cassandra.transforms import SearchCompressor, SearchCompressorConfig

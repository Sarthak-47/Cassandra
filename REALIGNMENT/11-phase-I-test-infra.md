...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I1-sha256-round-trip`
**Risk:** **LOW**
**LOC:** +400
...
- `crates/cassandra-proxy/tests/integration_byte_faithful.rs::sha256_round_trip_anthropic_messages_passthrough`
- `crates/cassandra-proxy/tests/integration_byte_faithful.rs::sha256_round_trip_anthropic_messages_compression_off_via_auth_mode`
- `crates/cassandra-proxy/tests/integration_byte_faithful.rs::sha256_round_trip_openai_chat`
- `crates/cassandra-proxy/tests/integration_byte_faithful.rs::sha256_round_trip_openai_responses`
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I2-sse-corner-cases`
**Risk:** **LOW**
**LOC:** +800
...
**Add:**
- `crates/cassandra-proxy/tests/fixtures/sse/anthropic_thinking_with_signature.sse`
- `crates/cassandra-proxy/tests/fixtures/sse/anthropic_interleaved_blocks.sse` (synthetic; locks the index-keyed model)
- `crates/cassandra-proxy/tests/fixtures/sse/anthropic_input_json_delta_split_utf8.sse` (4-byte emoji split across chunks)
- `crates/cassandra-proxy/tests/fixtures/sse/anthropic_ping_mid_stream.sse`
- `crates/cassandra-proxy/tests/fixtures/sse/anthropic_error_mid_stream.sse`
- `crates/cassandra-proxy/tests/fixtures/sse/openai_chat_tool_call_split.sse`
- `crates/cassandra-proxy/tests/fixtures/sse/openai_chat_done_with_trailing_whitespace.sse`
- `crates/cassandra-proxy/tests/fixtures/sse/openai_responses_out_of_order_done.sse`
- `crates/cassandra-proxy/tests/fixtures/sse/openai_429_as_application_json.http` (HTTP error, not SSE)
- `crates/cassandra-proxy/tests/fixtures/sse/anthropic_tcp_drop_before_message_stop.sse`
- `crates/cassandra-proxy/tests/integration_sse_fixtures.rs` — runs every fixture against the parser; asserts expected state.
- Property test in `crates/cassandra-proxy/tests/proptest_sse.rs::sse_parser_no_panic_on_arbitrary_bytes`.
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I3-compression-proptest`
**Risk:** **LOW**
**LOC:** +500
...
**Add:**
- `crates/cassandra-core/tests/proptest_compression.rs` — proptest strategies for `Block`, `Message`, `RequestBody`. Five property tests above.
- `crates/cassandra-core/tests/proptest_ccr.rs` — round-trip property test: `decompress(compress(content)) == content` for any content.
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I4-shadow-test`
**Risk:** **MEDIUM**
**LOC:** +1000
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I5-parity-stubs-to-real`
**Risk:** **MEDIUM**
**LOC:** +800

### Scope
Eliminate P6-64. `crates/cassandra-parity/src/lib.rs:172-174` stubs three comparators with `bail!()`:
...
**Modify:**
- `crates/cassandra-parity/src/lib.rs` — replace `stub_comparator!(CCRComparator, ...)` etc. with real impls.
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I6-parity-per-pr-gate`
**Risk:** **LOW**
**LOC:** +50
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I7-cache-hot-zone-tests`
**Risk:** **LOW**
**LOC:** +600
...
**Add:**
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::system_byte_equal_under_compression`
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::tools_byte_equal_under_compression` (modulo Phase E sort + schema-key sort, which is deterministic — assert post-sort byte-equal)
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::frozen_messages_byte_equal_under_compression`
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::reasoning_encrypted_content_byte_equal`
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::thinking_signature_byte_equal`
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::redacted_thinking_data_byte_equal`
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::compaction_encrypted_content_byte_equal`
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::v4a_patch_diff_byte_equal`
- `crates/cassandra-proxy/tests/integration_cache_hot_zone.rs::local_shell_call_argv_array_preserved`
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I8-tool-def-snapshot`
**Risk:** **LOW**
**LOC:** +300

### Scope
For every tool definition Cassandra auto-injects (`ccr_retrieve`, `memory_*`), pin the bytes via golden-file snapshot. Any change to a definition fails CI; a deliberate change requires updating the snapshot. This prevents accidental cache busts on Cassandra deploys.

### Files

**Add:**
- `crates/cassandra-core/tests/tool_def_byte_stability.rs::ccr_retrieve_definition_anthropic_byte_stable`
- `crates/cassandra-core/tests/tool_def_byte_stability.rs::ccr_retrieve_definition_openai_byte_stable`
- `crates/cassandra-core/tests/tool_def_byte_stability.rs::memory_save_definition_byte_stable`
- `crates/cassandra-core/tests/tool_def_byte_stability.rs::memory_search_definition_byte_stable`
- Golden files under `crates/cassandra-core/tests/golden/tool_defs/`.
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I9-cache-hit-rate-alarm`
**Risk:** **LOW**
**LOC:** +200
...
**Worktree:** `~/claude-projects/cassandra-worktrees/realign-I10-real-rtk-in-e2e`
**Risk:** **LOW**
**LOC:** +200

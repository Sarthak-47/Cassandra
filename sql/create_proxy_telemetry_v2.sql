...
-- This table matches every field the beacon code writes in cassandra/telemetry/beacon.py
...
CREATE INDEX IF NOT EXISTS idx_ptv2_version ON proxy_telemetry_v2(cassandra_version);

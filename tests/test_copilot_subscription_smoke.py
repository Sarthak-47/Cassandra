...
from cassandra import copilot_auth, copilot_linux_secret, copilot_macos_keychain
...
def _stub_all_secret_stores(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(copilot_auth, "read_cassandra_copilot_oauth_token", lambda: None)

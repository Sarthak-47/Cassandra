"""Tests for :class:`cassandra.proxy.memory_query.MemoryQuery`.
...
def test_empty_user_text_is_valid_when_only_tool_signal() -> None:
    ...
    q = MemoryQuery(
        user_text="",
        recent_tool_outputs=("ls -la /home/user/projects/cassandra",),
        recent_assistant_turns=(),
        conversation_id=None,
    )
    txt = q.to_embedding_input()
    assert "ls -la /home/user/projects/cassandra" in txt

...
class TestMemoryList:
    """Tests for 'cassandra memory list' command."""
...
class TestMemoryShow:
    """Tests for 'cassandra memory show' command."""
...
class TestMemoryStats:
    """Tests for 'cassandra memory stats' command."""
...
class TestMemoryEdit:
    """Tests for 'cassandra memory edit' command."""
...
class TestMemoryDelete:
    """Tests for 'cassandra memory delete' command."""
...
class TestMemoryPrune:
    """Tests for 'cassandra memory prune' command."""
...
class TestMemoryPurge:
    """Tests for 'cassandra memory purge' command."""

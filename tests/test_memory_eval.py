...
from cassandra.evals.memory.judge import _parse_judge_response, simple_judge
...
class TestMemoryEvalConfig:
    ...
    def test_default_config(self):
        ...
        from cassandra.evals.memory import MemoryEvalConfig
...
class TestMemoryEvalResult:
    ...
    def test_eval_result_to_dict(self):
        ...
        from cassandra.evals.memory.runner import MemoryEvalResult
    ...
    def test_suite_result_summary(self):
        ...
        from cassandra.evals.memory.runner import MemoryEvalSuiteResult

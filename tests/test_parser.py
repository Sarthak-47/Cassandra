...
class TestRereadDetection:
    ...
    def test_reread_in_total_and_dict(self):
        ...
        from cassandra.config import WasteSignals
...
# --- Anthropic tool_result content blocks (Sarthak-47/cassandra#813) ---
...
class TestCallArgMatchReread:
    ...
    def test_canonical_call_key_normalizes_serialization(self):
        ...
        from cassandra.parser import _canonical_call_key

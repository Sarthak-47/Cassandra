...
from cassandra.backends.litellm import LiteLLMBackend  # noqa: E402  (must follow importorskip)
...
async def test_anthropic_style_cache_fields_surface_in_usage_block() -> None:
    ...
    with patch("cassandra.backends.litellm.acompletion", new_callable=AsyncMock) as mock_acomp:

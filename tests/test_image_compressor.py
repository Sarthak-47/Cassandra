...
from cassandra.image.compressor import (  # noqa: E402
    CompressionResult,
    ImageCompressor,
    Technique,
    compress_images,
...
from cassandra.image.trained_router import (  # noqa: E402
    ImageSignals,
    RouteDecision,
    TrainedRouter,
)
...
class TestTrainedRouterMocked:
    ...
    def test_release_models_unloads_registry_entries(self):
        ...
        with patch("cassandra.models.ml_models.MLModelRegistry.unload_many") as unload_many:

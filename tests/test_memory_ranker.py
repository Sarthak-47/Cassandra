"""Tests for :class:`cassandra.proxy.memory_ranker.MemoryRanker` +
:class:`RecencyBoostRanker`.

Pre-this-PR Cassandra ranked memory candidates by pure cosine
...
from cassandra.proxy.memory_ranker import (
    MemoryCandidate,
    RecencyBoostRanker,
)

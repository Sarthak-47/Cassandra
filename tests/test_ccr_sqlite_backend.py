...
from cassandra.cache.backends.sqlite import SQLiteBackend
from cassandra.cache.compression_store import CompressionEntry, CompressionStore
...
class TestSQLiteBackend:
    ...
    def test_unknown_json_fields_tolerated(self, db_path):
        """Forward-compat: entries written by a newer cassandra version
...
class TestDefaults:
    def test_session_scale_ttl_lockstep(self):
        ...
        from cassandra.config import CCRConfig
    ...
    def test_default_backend_is_sqlite(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setenv("CASSANDRA_CCR_SQLITE_PATH", str(tmp_path / "d.db"))
    ...
    def test_miss_message_is_actionable(self):
        from cassandra.cache.compression_store import CCR_MISS_MESSAGE

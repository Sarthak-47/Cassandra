...
def reset_globals(monkeypatch, tmp_path):
    ...
    Also disables disk persistence by setting CASSANDRA_TOIN_PATH to a temp file
    to avoid loading stale data from ~/.cassandra/toin.json.
    """
...
class TestTOINConfig:
    ...
    def test_default_values(self):
        ...
        # Storage path comes from CASSANDRA_TOIN_PATH env var (set by fixture) or default

...
Covers the fixes in:
- cassandra/memory/adapters/embedders.py (HF env vars, httpx logger)
- cassandra/providers/anthropic.py (warn=False suppresses tiktoken warning)
- cassandra/providers/litellm.py (suppress_debug_info, set_verbose)
- cassandra/transforms/html_extractor.py (trafilatura logger CRITICAL)
"""
...
class TestAnthropicWarnParameter:
    ...
    def test_warn_true_emits_warning_without_client(self):
        ...
        import cassandra.providers.anthropic as _mod
    ...
    def test_registry_uses_warn_false(self):
        ...
        from cassandra.providers import registry as _registry_mod
...
class TestEmbedderLogLevels:
    """cassandra.memory.adapters.embedders must set specific logger levels at import time."""

    def test_huggingface_hub_logger_is_error_or_higher(self):
        """huggingface_hub logger must be silenced to ERROR or above."""
        import cassandra.memory.adapters.embedders  # noqa: F401
...
class TestLiteLLMLogSuppression:
    ...
    def test_litellm_suppress_env_is_set_before_import(self, monkeypatch):
        ...
        sys.modules.pop("cassandra.providers.litellm", None)
        ...
        try:
            importlib.import_module("cassandra.providers.litellm")
        finally:
            sys.modules.pop("cassandra.providers.litellm", None)
            sys.modules.pop("litellm", None)
    ...
    def test_litellm_suppress_debug_info_is_set(self):
        ...
        import cassandra.providers.litellm  # noqa: F401
...
class TestTrafilaturaLogLevel:
    ...
    def test_trafilatura_logger_is_critical(self):
        ...
        import cassandra.transforms.html_extractor  # noqa: F401

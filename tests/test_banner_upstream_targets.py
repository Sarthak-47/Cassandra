...
from cassandra.providers.claude import DEFAULT_API_URL as DEFAULT_ANTHROPIC_API_URL  # noqa: E402
from cassandra.providers.codex import DEFAULT_API_URL as DEFAULT_OPENAI_API_URL  # noqa: E402
from cassandra.providers.gemini import DEFAULT_API_URL as DEFAULT_GEMINI_API_URL  # noqa: E402
from cassandra.providers.registry import (  # noqa: E402
    DEFAULT_CLOUDCODE_API_URL,
    DEFAULT_VERTEX_API_URL,
)
from cassandra.proxy.models import ProxyConfig  # noqa: E402
from cassandra.proxy.server import run_server  # noqa: E402
...
class TestBannerUpstreamTargets:
    ...
    def _capture_banner(self, config: ProxyConfig | None = None) -> str:
        ...
        with (
            ...
            patch("cassandra.proxy.server.uvicorn") as mock_uvicorn,
            patch("cassandra.proxy.server.create_app"),
        ):

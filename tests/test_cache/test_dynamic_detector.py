...
from cassandra.cache.dynamic_detector import (
    DetectionResult,
    DetectorConfig,
    DynamicCategory,
...
class TestEntropyDetection:
    ...
    def test_high_entropy_string(self):
        ...
        from cassandra.cache.dynamic_detector import calculate_entropy
...
class TestNERDetector:
    ...
    def ner_detector(self):
        ...
        from cassandra.cache.dynamic_detector import _SPACY_AVAILABLE, NERDetector
...
class TestSemanticDetector:
    ...
    def test_missing_exemplar_embeddings_returns_warning(self):
        ...
        from cassandra.cache.dynamic_detector import SemanticDetector

...
class TestExtractionBenchmark:
    ...
    @pytest.fixture
    def extractor(self):
        from cassandra.transforms.html_extractor import HTMLExtractor
    ...
    def test_extraction_f1_quick(self, extractor):
        ...
        pytest.importorskip("datasets")
        from cassandra.evals.html_oss_benchmarks import evaluate_scrapinghub_benchmark
...
class TestMetrics:
    ...
    def test_f1_computation(self):
        from cassandra.evals.html_oss_benchmarks import compute_f1
    ...
    def test_exact_match(self):
        from cassandra.evals.html_oss_benchmarks import compute_exact_match
...
Answer:"""
    ...
    def test_qa_accuracy_squad_quick(self, answer_fn):
        ...
        pytest.importorskip("datasets")
        from cassandra.evals.html_oss_benchmarks import evaluate_qa_accuracy_preservation
...
Answer concisely:"""
    ...
    def test_full_suite(self, answer_fn):
        ...
        pytest.importorskip("datasets")
        from cassandra.evals.html_oss_benchmarks import run_full_benchmark_suite
...
class TestBenchmarkInfrastructure:
    ...
    def test_result_classes(self):
        ...
        from cassandra.evals.html_oss_benchmarks import (

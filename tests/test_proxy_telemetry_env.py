...
from cassandra.proxy.server import ProxyConfig, _proxy_config_from_env, create_app


class TestProxyPeriodicTOINStatsEnv:
    """Test CASSANDRA_PERIODIC_TOIN_STATS handling for long-lived proxy workers."""
    ...
    def test_periodic_toin_stats_enabled_by_default(self, monkeypatch):
        ...
        monkeypatch.delenv("CASSANDRA_PERIODIC_TOIN_STATS", raising=False)
    ...
    def test_periodic_toin_stats_can_be_disabled_by_env(self, monkeypatch, value):
        """CASSANDRA_PERIODIC_TOIN_STATS=0/false/off/no disables periodic logging."""
        monkeypatch.setenv("CASSANDRA_PERIODIC_TOIN_STATS", value)
    ...
    def test_lifespan_skips_periodic_toin_stats_when_disabled(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "cassandra.proxy.server._log_toin_stats_periodically",

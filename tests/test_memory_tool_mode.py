...
from cassandra.proxy.memory_handler import MemoryConfig, MemoryHandler, MemoryMode
...
def test_tool_mode_skip_emits_structured_log(caplog: Any) -> None:
    ...
    ``cassandra.propagate=False`` and attaches a file handler. The conftest
    ...
    target_logger = logging.getLogger("cassandra.proxy.memory_handler")

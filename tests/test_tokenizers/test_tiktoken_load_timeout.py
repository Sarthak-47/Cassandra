...
from cassandra.tokenizers import tiktoken_counter as tc
from cassandra.tokenizers.estimator import EstimatingTokenCounter
from cassandra.tokenizers.registry import TokenizerRegistry
...
def test_load_encoding_is_bounded_on_stall(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("CASSANDRA_TIKTOKEN_LOAD_TIMEOUT_SECONDS", "0.2")

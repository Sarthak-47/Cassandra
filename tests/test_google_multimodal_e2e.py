...
async def test_through_proxy(api_key, proxy_url: str = "http://localhost:8080"):
    """Test multimodal requests through the Cassandra proxy."""
    print(f"\n=== Test 6: Through Cassandra Proxy ({proxy_url}) ===")
    ...
    try:
        ...
        print("   To test through proxy, start it with: uv run cassandra-proxy")
        return None

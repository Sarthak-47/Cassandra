...
from cassandra.providers.cursor import build_proxy_targets, render_setup_lines
from cassandra.providers.cursor.install import build_install_env


def test_cursor_proxy_targets_use_local_cassandra_proxy() -> None:

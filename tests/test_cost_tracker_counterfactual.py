...
def test_no_cost_without_cassandra_field():
    """cost_without_cassandra_usd should NOT be in stats (removed to avoid confusion)."""
    from cassandra.proxy.server import CostTracker
    ...
    assert "cost_without_cassandra_usd" not in stats

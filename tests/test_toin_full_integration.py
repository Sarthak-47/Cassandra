...
class TestTOINDefaultStoragePath:
    ...
    def test_toin_default_storage_path_exists(self):
        ...
        print("Expected location: ~/.cassandra/toin.json")
        ...
        expected_suffix = ".cassandra/toin.json"
    ...
    def test_cassandra_toin_path_env_var(self):
        """Verify CASSANDRA_TOIN_PATH env var overrides default."""
        print("\n" + "=" * 60)
        print("TEST: test_cassandra_toin_path_env_var")
        print("=" * 60)
        ...
        try:
            ...
            print("\n[PASS] CASSANDRA_TOIN_PATH env var works correctly")
    ...
    def test_empty_env_var_uses_default(self):
        """Verify empty CASSANDRA_TOIN_PATH falls back to default."""
        print("\n" + "=" * 60)
        ...
        try:
            ...
            # Should fall back to default ~/.cassandra/toin.json
            assert ".cassandra/toin.json" in default_path, (

"""Unit tests for cassandra.proxy lazy __getattr__ (PEP 562)."""
...
def test_proxy_getattr_resolves_create_app_and_caches_it(monkeypatch) -> None:
    ...
    monkeypatch.setitem(sys.modules, "cassandra.proxy.server", fake_server)

    import cassandra.proxy as proxy

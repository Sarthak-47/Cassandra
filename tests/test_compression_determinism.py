...
_FIXTURES: dict[str, str] = {
    "git_diff_wrapped": (
        ...
        "Output:\n"
        "cassandra/proxy/handlers/openai.py | 12 ++++++++++++\n"
        " 1 file changed, 12 insertions(+)\n\n"
        "--- Changes ---\n\n"
        "diff --git a/cassandra/proxy/handlers/openai.py b/cassandra/proxy/handlers/openai.py\n"
        "@@ -10,6 +10,18 @@\n"
        " def handle():\n"
    ...
    "plain_long_text": " ".join(["cassandra"] * 400),
}

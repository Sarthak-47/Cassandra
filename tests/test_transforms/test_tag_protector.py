...
from cassandra.transforms.tag_protector import (
    KNOWN_HTML_TAGS,
    _is_html_tag,
    protect_tags,
    restore_tags,
...
class TestRestoreTags:
    ...
    def test_lost_placeholder_discards_wrap(self):
        ...
        protected = [("{{CASSANDRA_TAG_0}}", "<tag>data</tag>")]
    ...
    def test_lost_placeholder_idempotent_when_all_missing(self):
        ...
        protected = [
            ("{{CASSANDRA_TAG_0}}", "<a>1</a>"),
            ("{{CASSANDRA_TAG_1}}", "<b>2</b>"),
            ("{{CASSANDRA_TAG_2}}", "<c>3</c>"),
        ]
    ...
    def test_partial_loss_keeps_present_discards_lost(self):
        ...
        protected = [
            ("{{CASSANDRA_TAG_0}}", "<a>1</a>"),
            ("{{CASSANDRA_TAG_1}}", "<lost>x</lost>"),
        ]
        result = restore_tags("head {{CASSANDRA_TAG_0}} tail", protected)

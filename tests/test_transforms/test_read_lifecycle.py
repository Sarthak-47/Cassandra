...
from cassandra.config import ReadLifecycleConfig
from cassandra.transforms.read_lifecycle import (
...
class TestContentRouterIntegration:
    ...
    ReadLifecycleManager so STALE Read markers resolve via cassandra_retrieve."""

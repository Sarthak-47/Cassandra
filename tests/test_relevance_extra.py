...
import cassandra.relevance as relevance_mod
from cassandra.relevance import (
    BM25Scorer,
    EmbeddingScorer,
    HybridScorer,
    create_scorer,
...
from cassandra.relevance.base import RelevanceScore, RelevanceScorer, default_batch_score

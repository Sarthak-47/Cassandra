...
class TestStreamingMetrics:
    ...
    def test_create_metrics(self):
        ...
        from cassandra.integrations.langchain.streaming import StreamingMetrics
...
class TestStreamingMetricsTrackerInit:
    ...
    def test_init_defaults(self):
        ...
        with patch("cassandra.integrations.langchain.streaming.OpenAIProvider"):
...
class TestStreamingMetricsTrackerFinish:
    ...
    def test_finish_returns_metrics(self, mock_provider, sample_chunks):
        ...
        from cassandra.integrations.langchain.streaming import (
            StreamingMetrics,
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from cassandra.integrations.langchain.streaming import _check_langchain_available

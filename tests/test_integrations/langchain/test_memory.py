...
Tests cover:
1. CassandraChatMessageHistory - Wrapper for chat message history with compression
...
class TestCassandraChatMessageHistoryInit:
    """Tests for CassandraChatMessageHistory initialization."""
    ...
    def test_init_defaults(self, mock_base_history):
        ...
        with patch("cassandra.integrations.langchain.memory.OpenAIProvider"):
            history = CassandraChatMessageHistory(mock_base_history)
...
class TestCassandraChatMessageHistoryMessages:
    ...
    def test_messages_returns_empty_when_no_messages(self, mock_base_history, mock_provider):
        ...
        history = CassandraChatMessageHistory(mock_base_history, provider=mock_provider)
...
class TestCassandraChatMessageHistoryAddMessage:
...
class TestCassandraChatMessageHistoryConversion:
...
class TestCassandraChatMessageHistoryTokenCounting:
...
class TestCassandraChatMessageHistoryStats:
...
class TestCassandraChatMessageHistoryCompression:
    ...
    def test_apply_compression_calls_pipeline(self, mock_base_history, mock_provider):
        ...
        with patch("cassandra.integrations.langchain.memory.TransformPipeline") as MockPipeline:
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from cassandra.integrations.langchain.memory import _check_langchain_available

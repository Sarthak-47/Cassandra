...
3. CassandraToolWrapper - Wrapper for LangChain tools with compression
4. wrap_tools_with_cassandra - Convenience function for wrapping multiple tools
...
class TestToolCompressionMetrics:
    ...
    def test_create_metrics(self):
        ...
        from cassandra.integrations.langchain.agents import ToolCompressionMetrics
...
class TestToolMetricsCollector:
    ...
    def test_init_empty(self):
        ...
        from cassandra.integrations.langchain.agents import ToolMetricsCollector
...
class TestCassandraToolWrapper:
    """Tests for CassandraToolWrapper."""
    ...
    def test_call_large_output_triggers_compression(self, mock_tool_with_large_output):
        ...
        with patch("cassandra.integrations.langchain.agents.compress_tool_result") as mock_compress:
...
class TestWrapToolsWithCassandra:
    """Tests for wrap_tools_with_cassandra function."""

    def test_wrap_single_tool(self, mock_tool):
        """Wrap a single tool."""
        from cassandra.integrations.langchain.agents import wrap_tools_with_cassandra

        wrapped = wrap_tools_with_cassandra([mock_tool])
    ...
    def test_wrap_multiple_tools(self, mock_tool):
        ...
        wrapped = wrap_tools_with_cassandra([mock_tool, tool2])
    ...
    def test_wrap_with_custom_threshold(self, mock_tool):
        ...
        wrapped = wrap_tools_with_cassandra([mock_tool], min_chars_to_compress=500)
    ...
    def test_wrap_with_shared_collector(self, mock_tool):
        ...
        wrapped = wrap_tools_with_cassandra(
            [mock_tool, tool2],
            metrics_collector=collector,
        )
...
class TestGlobalMetrics:
    ...
    def test_wrapper_uses_global_metrics_by_default(self, mock_tool):
        """CassandraToolWrapper uses global metrics by default."""
        from cassandra.integrations.langchain.agents import (
            CassandraToolWrapper,
            get_tool_metrics,
            reset_tool_metrics,
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from cassandra.integrations.langchain.agents import _check_langchain_available

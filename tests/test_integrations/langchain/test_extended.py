...
2. langchain_memory - CassandraChatMessageHistory
3. langchain_retriever - CassandraDocumentCompressor
4. langchain_agents - CassandraToolWrapper
...
class TestProviderDetection:
    ...
    def test_detect_openai_provider(self):
        ...
        from cassandra.integrations.langchain.providers import detect_provider
    ...
    def test_get_cassandra_provider_openai(self):
        """Get OpenAIProvider for OpenAI model."""
        from cassandra.integrations.langchain.providers import get_cassandra_provider
        ...
        provider = get_cassandra_provider(mock_model)
        assert isinstance(provider, OpenAIProvider)

    def test_get_cassandra_provider_anthropic(self):
    ...
    def test_get_model_name_from_langchain(self):
        ...
        from cassandra.integrations.langchain.providers import get_model_name_from_langchain
...
class TestCassandraChatMessageHistory:
    """Tests for CassandraChatMessageHistory memory wrapper."""
    ...
    def test_init(self):
        ...
        wrapper = CassandraChatMessageHistory(
            mock_history,
    ...
    def test_add_message_delegates(self):
        ...
        wrapper = CassandraChatMessageHistory(mock_history)
...
class TestCassandraDocumentCompressor:
    """Tests for CassandraDocumentCompressor retriever integration."""

    def test_init(self):
        """Initialize with defaults."""
        from cassandra.integrations.langchain.retriever import CassandraDocumentCompressor
    ...
    def test_compress_passthrough_under_limit(self):
        ...
        compressor = CassandraDocumentCompressor(max_documents=10)
    ...
    def test_compress_reduces_to_max(self):
        ...
        compressor = CassandraDocumentCompressor(max_documents=2)
    ...
    def test_compress_prefers_relevant(self):
        ...
        compressor = CassandraDocumentCompressor(max_documents=1)
...
class TestCassandraToolWrapper:
    """Tests for CassandraToolWrapper agent integration."""

    def test_init(self):
        """Initialize wrapper."""
        from cassandra.integrations.langchain.agents import CassandraToolWrapper

        mock_tool = MagicMock()
        mock_tool.name = "test_tool"
        mock_tool.description = "A test tool"

        wrapper = CassandraToolWrapper(mock_tool)
    ...
    def test_call_passthrough_small_output(self):
        ...
        wrapper = CassandraToolWrapper(mock_tool, min_chars_to_compress=1000)
    ...
    def test_call_compresses_large_json(self):
        ...
        wrapper = CassandraToolWrapper(mock_tool, min_chars_to_compress=100)
        result = wrapper("query")
    ...
    def test_wrap_tools_with_cassandra(self):
        """Wrap multiple tools at once."""
        from cassandra.integrations.langchain.agents import wrap_tools_with_cassandra
        ...
        wrapped = wrap_tools_with_cassandra(tools)
    ...
    def test_metrics_collector(self):
        ...
        from cassandra.integrations.langchain.agents import (
        ...
        wrapper = CassandraToolWrapper(mock_tool, metrics_collector=collector)
        wrapper("query")
...
class TestCassandraLangSmithCallbackHandler:
    """Tests for LangSmith integration."""

    def test_init(self):
        """Initialize handler."""
        from cassandra.integrations.langchain.langsmith import (
            CassandraLangSmithCallbackHandler,
        )

        handler = CassandraLangSmithCallbackHandler(auto_update_runs=False)

        assert handler._auto_update is False
        assert handler._pending_metrics == {}

    def test_set_cassandra_metrics(self):
    ...
    def test_get_run_metrics(self):
        ...
        handler = CassandraLangSmithCallbackHandler(auto_update_runs=False)
        handler._run_metrics["run-1"] = {"cassandra.tokens_saved": 100}

        metrics = handler.get_run_metrics("run-1")
        assert metrics["cassandra.tokens_saved"] == 100
    ...
    def test_get_summary(self):
        ...
        handler._run_metrics = {
            "run-1": {"cassandra.tokens_saved": 100, "cassandra.savings_percent": 20},
            "run-2": {"cassandra.tokens_saved": 200, "cassandra.savings_percent": 30},
        }
...
class TestStreamingMetricsTracker:
    ...
    def test_init(self):
        """Initialize tracker."""
        from cassandra.integrations.langchain.streaming import StreamingMetricsTracker
    ...
    def test_streaming_metrics_callback(self):
        ...
        from cassandra.integrations.langchain.streaming import StreamingMetricsCallback
    ...
    def test_track_streaming_response(self):
        ...
        from cassandra.integrations.langchain.streaming import track_streaming_response
...
class TestAutoDetectProviderInChatModel:
    """Tests for auto_detect_provider in CassandraChatModel."""
    ...
    def test_auto_detect_enabled_by_default(self):
        ...
        model = CassandraChatModel(mock_model)
    ...
    def test_auto_detect_can_be_disabled(self):
        ...
        model = CassandraChatModel(mock_model, auto_detect_provider=False)

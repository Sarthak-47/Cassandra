...
These tests verify that Cassandra correctly compresses MCP tool outputs
...
from cassandra.integrations.mcp import (
...
from cassandra.transforms.smart_crusher import strip_ccr_sentinels
...
class TestMCPClientWrapper:
    ...
    async def test_wrapper_compresses_automatically(self, mock_mcp_client):
        ...
        wrapper = CassandraMCPClientWrapper(mock_mcp_client)
...
class TestMCPCustomProfiles:
    ...
    def test_custom_profile(self):
        ...
        compressor = CassandraMCPCompressor(profiles=custom_profiles)

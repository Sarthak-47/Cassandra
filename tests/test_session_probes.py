...
from cassandra.evals.session_probes import (
    DIMENSIONS,
    DimensionTally,
...
ORIGINAL_TOOL_TEXT = (
    ...
    "retry_limit: 3\n"
    "port=8787\n"
    "see cassandra/proxy/server.py and https://example.com/build/42\n"
    "commit d293b77ab12\n"
...
class TestExtractProbeTargets:
    ...
    def test_extracts_artifacts(self):
        text = (
            "path cassandra/proxy/server.py url https://example.com/build/42 "
            "hash d293b77ab12 id 123e4567-e89b-42d3-a456-426614174000"
        )
        targets = extract_probe_targets(text)

        assert "cassandra/proxy/server.py" in targets["artifacts"]

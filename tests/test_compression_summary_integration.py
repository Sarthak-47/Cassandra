...
class TestSummaryHelpfulness:
    ...
    def test_find_failures_with_summary(self):
        ...
        compressed_output += (
            'Retrieve specific items: cassandra_retrieve(hash="abc123", query="your search")]'
        )
...
class PaymentProcessor:
    ...
    def get_balance(self) -> float:
        ...
        pass
'''
        from cassandra.transforms.compression_summary import summarize_compressed_code

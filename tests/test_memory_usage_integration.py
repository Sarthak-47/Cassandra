...
def get_tracked_memory() -> dict:
    ...
    from cassandra.memory.tracker import MemoryTracker
...
class TestMemorySystemIntegration:
    ...
    async def test_graph_store_memory_growth(self):
        ...
        from cassandra.memory.adapters.graph_models import Entity, Relationship
        from cassandra.memory.tracker import MemoryTracker
...
class TestCCRIntegration:
    ...
    def reset_stores(self):
        ...
        from cassandra.ccr.batch_store import reset_batch_context_store
        from cassandra.memory.tracker import MemoryTracker
    ...
    def test_compression_store_memory_growth(self):
        ...
        from cassandra.cache.compression_store import CompressionStore
        from cassandra.memory.tracker import MemoryTracker
    ...
    def test_batch_context_store_memory_growth(self):
        ...
        from cassandra.ccr.batch_store import (
            BatchContext,
            BatchContextStore,
            BatchRequestContext,
        )
...
class TestProxyMemoryIntegration:
    ...
    def test_real_api_calls_memory_tracking(self, api_key):
        ...
        from cassandra.cache.compression_store import CompressionStore
        from cassandra.ccr.batch_store import BatchContextStore
...
class TestCombinedMemoryTracking:
    ...
    async def test_all_components_memory_tracking(self):
        ...
        from cassandra.cache.compression_store import CompressionStore
        from cassandra.ccr.batch_store import BatchContext, BatchContextStore, BatchRequestContext
        from cassandra.memory.adapters.graph import InMemoryGraphStore
        from cassandra.memory.adapters.graph_models import Entity, Relationship
        from cassandra.memory.adapters.hnsw import HNSWVectorIndex
        from cassandra.memory.models import Memory

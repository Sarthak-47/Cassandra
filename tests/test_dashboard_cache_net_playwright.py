...
and ``prefix_cache.prefix_freeze`` (built in ``cassandra/proxy/cost.py``)
...
def _open_dashboard(page: Page, stats: dict) -> None:
    ...
    page.goto("http://cassandra.local/dashboard")
    page.wait_for_load_state("networkidle")


def test_dashboard_renders_compression_vs_cache_net_metrics() -> None:
    artifact_dir = os.environ.get("CASSANDRA_PLAYWRIGHT_ARTIFACT_DIR")

...
from cassandra.learn.models import ProjectInfo, Recommendation, RecommendationTarget
from cassandra.learn.scanner import GeminiScanner
from cassandra.learn.writer import GeminiWriter
...
class TestToolNameNormalization:
    def test_all_known_names(self):
        from cassandra.learn._shared import normalize_tool_name

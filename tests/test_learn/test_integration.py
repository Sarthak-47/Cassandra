"""Integration tests for cassandra learn — using real session data.
...
from cassandra.learn.analyzer import SessionAnalyzer
from cassandra.learn.models import (
    ProjectInfo,
    Recommendation,
    RecommendationTarget,
)
from cassandra.learn.scanner import _greedy_path_decode
from cassandra.learn.writer import ClaudeCodeWriter, CodexWriter
...
class TestFalsePositiveFiltering:
    ...
    def test_sed_output_not_error(self):
        ...
        from cassandra.learn.scanner import is_error_content
...
class TestClaudeCodeIntegration:
    ...
    def test_scanner_discovers_projects(self):
        from cassandra.learn.scanner import ClaudeCodeScanner
    ...
    def test_dry_run_writes_nothing(self):
        ...
        with patch("cassandra.learn.analyzer._call_llm", return_value=mock_response):
            sessions = scanner.scan_project(best)
...
class TestCodexIntegration:
    ...
    def test_scanner_discovers_sessions(self):
        from cassandra.learn.scanner import CodexScanner

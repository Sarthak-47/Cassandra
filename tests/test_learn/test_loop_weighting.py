"""Tests for loop detection and loop-weighting in Cassandra Learn.
...
from cassandra.learn.analyzer import SessionAnalyzer, _build_digest
from cassandra.learn.fixtures import (
    error_loop_session,
    one_off_error_session,
    rtk_refetch_loop_session,
)
from cassandra.learn.loops import (

...
from cassandra.learn.writer import (
    _MARKER_END,
    _MARKER_START,
    ClaudeCodeWriter,
    _merge_into_file,
...
class TestClaudeCodeWriter:
    ...
    def test_hand_written_claude_md_left_untouched(self, tmp_path):
        ...
        # A hand-written CLAUDE.md with no cassandra block is left exactly as-is.
    ...
    def test_carries_forward_prior_sections_not_resurfaced(self, tmp_path):
        ...
        prior_block = (
            ...
            "*Auto-generated by `cassandra learn` on 2026-01-01 — do not edit manually*\n\n"
            "### Large Files\n"
...
class TestLegacyClaudeMdMigration:
    """A stale cassandra block in the shared CLAUDE.md migrates to CLAUDE.local.md."""
    ...
    def test_migrates_block_and_strips_legacy(self, tmp_path):
        ...
        # Hand-written content stays in CLAUDE.md; the cassandra block is gone.
    ...
    def test_block_only_claude_md_is_removed(self, tmp_path):
        proj = _project(tmp_path)
        claude_md = proj.project_path / "CLAUDE.md"
        # CLAUDE.md holds nothing but the Cassandra block (no hand-written content).
        claude_md.write_text(
            f"{_MARKER_START}\n## Cassandra Learned Patterns\n\n"
            "### Build Commands\n- cargo check\n\n"
            f"{_MARKER_END}\n"

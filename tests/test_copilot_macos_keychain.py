...
from cassandra import copilot_macos_keychain
...
def test_read_copilot_oauth_token_uses_security(
    ...
    monkeypatch.setenv("GITHUB_COPILOT_KEYCHAIN_ACCOUNT", "Sarthak-47")
...
def test_read_copilot_oauth_token_tries_copilot_cli_host_login_account(
    ...
    (copilot_home / "config.json").write_text(
        '{"lastLoggedInUser":{"host":"https://github.com","login":"Sarthak-47"}}',
        encoding="utf-8",
    )

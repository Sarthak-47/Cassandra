...
``cassandra mcp serve`` writes every compress / retrieve invocation to a
...
``cassandra_compress`` directly.

These tests pin the aggregation logic in
:func:`cassandra.proxy.cost._aggregate_mcp_events`.
"""

"""Integration tests for Cassandra Memory System.
...
class TestMemoryIntegration:
    ...
    def test_optimized_tools_have_extraction_fields(self):
        ...
        from cassandra.memory.tools import get_memory_tools, get_memory_tools_optimized
    ...
    def test_wrapper_uses_correct_tools(self, openai_client, temp_db_path, user_id):
        ...
        from cassandra.memory import with_memory_tools
    ...
    def test_extraction_prompt_injection(self, openai_client, temp_db_path, user_id):
        ...
        from cassandra.memory import with_memory_tools
        from cassandra.memory.backends.local import LocalBackend, LocalBackendConfig
        from cassandra.memory.extraction import EXTRACTION_SYSTEM_PROMPT
    ...
    async def test_local_backend_pre_extraction(self, temp_db_path, user_id):
        ...
        from cassandra.memory.adapters.graph_models import RelationshipDirection
    ...
    async def test_memory_system_tool_dispatch(self, temp_db_path, user_id):
        ...
        from cassandra.memory.backends.local import LocalBackend, LocalBackendConfig
        from cassandra.memory.system import MemorySystem
    ...
    def test_full_flow_save_then_search(self, openai_client, temp_db_path, user_id):
        ...
        save_response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "Remember this: My favorite programming language is Rust and I'm working on a CLI tool called cassandra.",
                },
            ],
        )
...
class TestExtractionPrompts:
    ...
    def test_extraction_prompts_exist_and_valid(self):
        ...
        from cassandra.memory.extraction import (
...
class TestWrapperToolsModule:
    ...
    def test_wrapper_tools_imports(self):
        ...
        from cassandra.memory.wrapper_tools import (
    ...
    def test_with_memory_tools_accepts_optimized_param(self):
        ...
        from cassandra.memory.wrapper_tools import with_memory_tools

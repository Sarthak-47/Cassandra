...
from cassandra.pricing.deepseek_prices import (
    DEEPSEEK_PRICES,
    get_deepseek_registry,
)
from cassandra.pricing.registry import PricingRegistry
...
class TestDeepSeekLiteLLMInjection:
    ...
    def test_deepseek_v4_models_in_litellm_model_cost(self):
        from cassandra.pricing.litellm_pricing import LITELLM_AVAILABLE, litellm
    ...
    def test_cost_per_token_resolves_deepseek_v4_flash(self):
        from cassandra.pricing.litellm_pricing import (
            LITELLM_AVAILABLE,
            litellm,

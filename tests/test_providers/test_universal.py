...
class TestOpenAICompatibleProvider:
    ...
    def test_get_token_counter_uses_registered_tokenizer_backend(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "cassandra.providers.openai_compatible.get_tokenizer",
...
class TestLiteLLMProvider:
    ...
    def test_unavailable_litellm_paths(self, monkeypatch):
        import cassandra.providers.litellm as litellm_module
    ...
    def test_create_litellm_provider(self):
        ...
        from cassandra.providers import create_litellm_provider
    ...
    def test_litellm_list_providers(self):
        ...
        from cassandra.providers import LiteLLMProvider

"""Tests for cassandra.learn.verbosity — behavioral signal extraction."""
...
from cassandra.learn.verbosity import (
    VerbositySignals,
    analyze,
    extract_signals,
    recommend_level,
...
class TestAnalyze:
    ...
    def test_profile_roundtrip(self, tmp_path):
        from cassandra.learn.verbosity import VerbosityProfile

"""Test OpenAI /v1/chat/completions streaming through cassandra proxy backends.

Proves that streaming works end-to-end: client → cassandra proxy → backend → OpenAI API.

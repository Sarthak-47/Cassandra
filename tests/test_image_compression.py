...
from cassandra.image.tile_optimizer import (
...
class TestOnnxRouter:
    ...
    def test_query_classification(self):
        ...
        from cassandra.image.onnx_router import OnnxTechniqueRouter, Technique
    ...
    def test_full_classify_with_image(self):
        ...
        from cassandra.image.onnx_router import OnnxTechniqueRouter
...
class TestOcrRouting:
    ...
    def test_transcode_replaces_image_with_text(self):
        ...
        from cassandra.image import ImageCompressor
        from cassandra.image.trained_router import Technique

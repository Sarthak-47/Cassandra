...
from cassandra.proxy.request_logger import RequestLogger
from cassandra.proxy.server import CassandraProxy


def _build_proxy_with_real_logger(*, log_full_messages: bool) -> CassandraProxy:
    """Build a CassandraProxy with mocks for everything except the request logger,

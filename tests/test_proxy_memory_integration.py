...
class TestMemoryHeaderValidation:
    ...
    def test_missing_user_id_uses_default(self, memory_client, anthropic_api_key):
        """Request without x-cassandra-user-id should use 'default' user for simple DevEx."""
        ...
        response = memory_client.post(
            ...
            headers={
                ...
                # Note: NOT setting x-cassandra-user-id - should default to "default"
            },
            json={
    ...
    def test_with_user_id_succeeds(self, memory_client, anthropic_api_key):
        """Request with x-cassandra-user-id should succeed."""
        if not anthropic_api_key:
            pytest.skip("ANTHROPIC_API_KEY not set")
        ...
        response = memory_client.post(
            ...
            headers={
                "x-api-key": anthropic_api_key,
                "anthropic-version": "2023-06-01",
                "x-cassandra-user-id": "test-user-123",
            },
            json={
                "model": "claude-sonnet-4-20250514",
                "max_tokens": 100,
    ...
    def test_memory_tools_are_available(self, memory_client, anthropic_api_key):
        ...
        response = memory_client.post(
            ...
            headers={
                "x-api-key": anthropic_api_key,
                "anthropic-version": "2023-06-01",
                "x-cassandra-user-id": "test-user-tool-check",
            },
            json={
                "model": "claude-sonnet-4-20250514",
                "max_tokens": 500,

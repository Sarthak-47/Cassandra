"""Unit tests for Strands CassandraStrandsModel.

These tests use mocks and do NOT require AWS credentials or strands-agents.
They test the internal logic of CassandraStrandsModel in isolation.
...
class TestCassandraStrandsModelInit:
    """Tests for CassandraStrandsModel initialization."""
    ...
    def test_init_with_defaults(self, mock_strands_model):
        ...
        model = CassandraStrandsModel(wrapped_model=mock_strands_model)
    ...
    def test_init_with_custom_config(self, mock_strands_model):
        """Initialize with custom CassandraConfig."""
    ...
    def test_init_requires_wrapped_model(self):
        ...
        with pytest.raises(ValueError, match="wrapped_model cannot be None"):
            CassandraStrandsModel(wrapped_model=None)
...
class TestOptimizeMessages:
    ...
    def test_optimize_returns_metrics(self, mock_strands_model, sample_messages):
        ...
        # Mock the pipeline by setting _pipeline directly and mocking _cassandra_provider
        ...
        model._cassandra_provider = MagicMock()
        model._cassandra_provider.get_context_limit.return_value = 128000
...
class TestPipelineLazyInit:
    ...
    def test_pipeline_is_lazily_initialized(self, mock_strands_model):
        ...
        with patch("cassandra.integrations.strands.model.TransformPipeline"):
            _ = model.pipeline
...
class TestGetSavingsSummary:
    ...
    def test_summary_with_metrics(self, mock_strands_model):
        ...
        from cassandra.integrations.strands import CassandraStrandsModel
        from cassandra.integrations.strands.model import OptimizationMetrics
...
class TestOptimizeMessagesFunction:
    ...
    def test_optimize_messages_basic(self):
        ...
        with patch("cassandra.integrations.strands.model.TransformPipeline") as MockPipeline:
...
class TestStrandsAvailableFunction:
    ...
    def test_strands_available_returns_bool(self):
        ...
        from cassandra.integrations.strands import strands_available
...
class TestRealCassandraIntegration:
    """Integration tests with real Cassandra (no mocking)."""

    def test_real_optimization_with_mock_model(self, mock_strands_model, sample_messages):
        """Test with real Cassandra transforms (no API calls)."""
        from cassandra.integrations.strands import CassandraStrandsModel
        ...
        # This calls real Cassandra optimization
        optimized, metrics = model._optimize_messages(sample_messages)

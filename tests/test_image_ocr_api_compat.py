...
`cassandra/image/compressor.py` adapts both at runtime via
...
from cassandra.image import compressor as compressor_module
from cassandra.image.compressor import ImageCompressor
...
def test_ocr_extract_v3_mismatched_lengths_logs_and_returns_none(
    ...
    c = _make_compressor()
    with caplog.at_level("WARNING", logger="cassandra.image.compressor"):

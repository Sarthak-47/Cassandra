...
from cassandra.memory.models import Memory, ScopeLevel
from cassandra.memory.ports import MemoryFilter, TextFilter, VectorFilter
...
class TestMemoryConfig:
    ...
    def test_default_config(self):
        ...
        from cassandra.memory.config import MemoryConfig
    ...
    def test_openai_requires_api_key(self):
        ...
        from cassandra.memory.config import EmbedderBackend, MemoryConfig

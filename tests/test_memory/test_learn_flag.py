...
class TestCassandraProxyTrafficLearner:
    """Test that CassandraProxy correctly initializes (or doesn't) the traffic learner."""
...
class TestWrapCLILearnFlag:
    ...
    def test_start_proxy_builds_learn_command(self):
        ...
        from cassandra.cli.wrap import _start_proxy
    ...
    def test_ensure_proxy_accepts_learn(self):
        ...
        from cassandra.cli.wrap import _ensure_proxy
    ...
    def test_launch_tool_accepts_learn(self):
        ...
        from cassandra.cli.wrap import _launch_tool

...
Cassandra compression preserves the information needed to answer correctly.
...
def main():
    ...
    print("\n" + "=" * 70)
    print("MCP AGENT EVALUATION: BEFORE vs AFTER CASSANDRA COMPRESSION")
    print("=" * 70)
    print("\nThis eval tests whether an agent can still find critical information")
    print("after Cassandra compresses large MCP tool outputs.")
    print("\nModel: gpt-4o-mini")
    ...
    if passed == total_cases:
        print("SUCCESS: All tests passed - Cassandra compression preserves critical info!")
    else:

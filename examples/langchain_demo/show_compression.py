"""Demonstrate Cassandra compression on LangChain tool outputs.

This script shows EXACTLY what Cassandra does to large tool outputs:
...
from cassandra.transforms import SmartCrusher
...
def main():
    ...
    print("\n" + "=" * 70)
    print("CASSANDRA SMARTCRUSHER: BEFORE/AFTER COMPRESSION")
    print("=" * 70)
    print("""
This demonstrates how Cassandra's SmartCrusher compresses large tool outputs.

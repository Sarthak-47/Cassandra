...
This directory contains examples demonstrating Cassandra's capabilities.
...
AWS Strands Agents + Bedrock integration demo. Showcases two Cassandra integration patterns:

1. **CassandraHookProvider** - Compresses tool outputs in real-time

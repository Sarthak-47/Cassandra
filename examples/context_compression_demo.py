...
Tests REAL Cassandra compression on realistic retriever tool outputs.
...
def main() -> None:
    print("=" * 70)
    print("Context Compression Demo (Real Cassandra, No Mocks)")
    print("=" * 70)
    ...
    # --- Compress with REAL Cassandra ---
    from cassandra import compress

    print("\nCompressing with Cassandra (real compress() call)...")
    ...
    print(f"  {'07-Cassandra Compression':<35} {hr_tokens:<10} {hr_pct:<10} {'No':<18} {'$0'}")

...
# used by `crates/cassandra-proxy/src/compression/model_limits.rs`.
#
...
DEST="$REPO_ROOT/crates/cassandra-proxy/data/model_prices_and_context_window.json"
...
echo "Updated $DEST"
echo "Run 'cargo test -p cassandra-proxy --lib compression::model_limits' to verify."

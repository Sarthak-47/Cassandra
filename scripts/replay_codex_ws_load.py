...
os.environ.setdefault("CASSANDRA_DISABLE_TELEMETRY", "true")
os.environ.setdefault("CASSANDRA_REQUIRE_RUST_CORE", "false")
...
def boot_proxy():
    """Build a CassandraProxy instance with optimize=True so the compression

...
def main() -> None:
    ...
    versions = {
        ...
        "plugins/cassandra-agent-hooks/.claude-plugin/plugin.json": _read_json_version(
            ROOT / "plugins/cassandra-agent-hooks/.claude-plugin/plugin.json"
        ),
        "plugins/cassandra-agent-hooks/.github/plugin/plugin.json": _read_json_version(

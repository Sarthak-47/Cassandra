 ...
 * Matches Python cassandra.shared_context.SharedContext.
 */

import { CassandraClient } from "./client.js";
import type { CassandraClientOptions, CompressResult } from "./types.js";
...
export interface SharedContextOptions extends CassandraClientOptions {
  model?: string;
  ttl?: number;
  maxEntries?: number;
}
...
export class SharedContext {
  ...
  constructor(options: SharedContextOptions = {}) {
    ...
    this.client = new CassandraClient(clientOptions);

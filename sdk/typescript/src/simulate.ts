...
import type { CassandraConfig } from "./types/config.js";
import { deepCamelCase, deepSnakeCase } from "./utils/case.js";
import { detectFormat, toOpenAI } from "./utils/format.js";

export interface SimulateOptions extends CassandraClientOptions {
  model?: string;
...
export async function simulate(
  ...
  const client = providedClient ?? new CassandraClient(clientOptions);

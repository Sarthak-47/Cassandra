/**
 * Core types for the Cassandra TypeScript SDK.
...
export interface CompressOptions {
  ...
  fallback?: boolean;
  retries?: number;
  client?: CassandraClientInterface;
  ...
  /** Integration slug sent as X-Cassandra-Stack (e.g. "adapter_ts_openai"). */
  stack?: string;
}
...
export interface CassandraClientOptions {
  ...
  fallback?: boolean;
  retries?: number;
  /** Integration slug sent as X-Cassandra-Stack on every request. */
  stack?: string;
}

export interface CassandraClientInterface {
  compress(

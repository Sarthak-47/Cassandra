 ...
 *
 * Combine cassandraMiddleware with other Vercel AI SDK middlewares.
 * Cassandra compresses first, then other middlewares process the result.
 *
...
async function main() {
  ...
  const model = wrapLanguageModel({
    model: openai("gpt-4o"),
    middleware: [
      cassandraMiddleware(), // compress large context

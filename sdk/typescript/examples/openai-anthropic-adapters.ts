 ...
 */
import { withCassandra as withCassandraOpenAI } from "cassandra-ai/openai";
import { withCassandra as withCassandraAnthropic } from "cassandra-ai/anthropic";
...
async function main() {
  ...
  if (process.env.OPENAI_API_KEY) {
    ...
    const openai = withCassandraOpenAI(new OpenAI());
  ...
  if (process.env.ANTHROPIC_API_KEY) {
    ...
    const anthropic = withCassandraAnthropic(new Anthropic());

 ...
 *
 * Use the same withCassandra wrapper across different providers.
 * Cassandra compresses identically regardless of which LLM you use.
 *
...
async function main() {
  ...
  const gpt = withCassandra(openai("gpt-4o"));
  ...
  const mini = withCassandra(openai("gpt-4o-mini"));

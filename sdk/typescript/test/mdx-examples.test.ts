 ...
 *
 * Run: CASSANDRA_INTEGRATION=1 npx vitest run test/mdx-examples.test.ts
 */
...
const RUN = process.env.CASSANDRA_INTEGRATION === "1";

describe.skipIf(!RUN)("MDX Examples: 51-cassandra.mdx", () => {
  beforeAll(async () => {
  ...
  // =====================================================
  // Example 1 from 51-cassandra.mdx: "Compress messages before calling the model"
  // =====================================================
  ...
  // =====================================================
  // Example 2 from 51-cassandra.mdx: "Use as middleware"
  // =====================================================
  it("cassandraMiddleware() with wrapLanguageModel → generateText()", { timeout: 30000 }, async () => {
    const { cassandraMiddleware } = await import("../src/adapters/vercel-ai.js");
    ...
    const model = wrapLanguageModel({
      model: openai("gpt-4o-mini"),
      middleware: cassandraMiddleware({ baseUrl: PROXY_URL }),
    });
  ...
  // =====================================================
  // Example 3 from 51-cassandra.mdx: "Works with any provider" (Anthropic)
  // =====================================================

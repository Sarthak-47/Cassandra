/**
 * Tests for expanded CassandraClient — chat.completions, messages, metrics, CCR, etc.
 * Uses mocked proxy (no real server needed).
 */
import { describe, it, expect, vi, beforeEach } from "vitest";
import { CassandraClient } from "../src/client.js";
...
describe("CassandraClient constructor", () => {
...
describe("CassandraClient.health()", () => {
  ...
  it("returns health status", async () => {
    ...
    const client = new CassandraClient({ baseUrl: "http://test:8787" });
...
describe("CassandraClient.proxyStats()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("CassandraClient.getMetrics()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("CassandraClient.getSummary()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("CassandraClient.validateSetup()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("CassandraClient.retrieve()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("CassandraClient.clearCache()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("CassandraClient.close()", () => {
...
describe("CassandraClient.compressRaw()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("CassandraClient config passthrough", () => {
  beforeEach(() => vi.clearAllMocks());
